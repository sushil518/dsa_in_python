...
class BinarySearchTree:
    ...
    def insert1(self,x):
        ...
        while p is not None:
            ...
            if x < p.info:
                ...
                print(x, " alreary present in the tree")
                return
        temp = Node(x)
    ...
    def search1(self,x):
        ...
        while p is not None:
            if x < p.info:
                ...
                p = p.rchild # move to rirght child
            else: # x found
                return True
        return False
    ...
    def delete1(self,x):
        ...
        while p is not None:
            ...
            # case C: 2 children
            # find inorder successor and ites parent
    ...
    def min1(self):
        if self.is_empty():
            raise TreeEmtpyError("Tree is emtpy")
        p = self.root
    ...
    def max1(self):
        if self.is_empty():
            raise TreeEmtpyError("Tree is empty")
        p = self.root
    ...
    def min2(self):
        if self.is_empty():
            raise TreeEmptyError("Tree is emtpy")
