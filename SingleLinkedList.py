...
class SingleLinkedList:
    ...
    def insert_at_position(self,data,k):
        ...
        while i<k-1 and p is not None: # find a reference to k-1 node
            ...
            i += 1
        if p is None:
            print("You can insert onlty upto position ", i)
        else:
            temp = Node(data)
            temp.link = p.link
            p.link = temp
    ...
    def remove_cycle(self):
        ...
        if c is None:
            return
        print("Node at which the was detected ", c.info)
        p = c
        q = c
        len_cycle = 0
        ...
        print("Number of nodes not inlcuded in the cycle are : len_rem_list: ", len_rem_list)
    ...
    def _merge1(self,p1,p2):
        ...
        #if second list has finished and element left in first list
...
while True:
    ...
    if option == 1:
        ...
        data = int(input("Enter the element at whicih cycle has to be inserted : "))
